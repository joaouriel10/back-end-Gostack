...
let fakeApponentsRepository: FakeApponentsRepository;
let createAppointment: CreateAppointmentService;

describe('CreateAppointment', () => {
    beforeEach(() =>{
        fakeApponentsRepository = new FakeApponentsRepository();
        createAppointment = new CreateAppointmentService(fakeApponentsRepository);
    });
